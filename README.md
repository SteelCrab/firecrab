...
`npm test --prefix firecrab-e2e` runs all 5 spec files (OCI import, MicroRegistry
register, MicroNetwork IPv6, OCI DHCP boot, pools) together; per-suite pass/skip counts,
