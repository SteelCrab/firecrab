...
| 증상 | 원인 |
|---|---|
| guest가 `no-ipv4-address` | UFW가 새 브리지의 DHCP를 막음 ([troubleshooting](troubleshooting.md)) |
| VM 아웃바운드 타임아웃 | UFW가 라우팅 기본 거부 ([bug](bugs/vm-outbound-forward-blocked-by-ufw.md)) |
