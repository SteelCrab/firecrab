...
> VM을 그중 하나에 소속시킨다.
> 이 문서는 3주차에 완료된 범위의 기록 — 격리 강화(VRF 등)는 [4주차](weeks/week4-tasks.md) 플랜.
...
- 테스트 절차는 [tests/micro-network](../40-tests/micro-network.md)
...
[4주차](weeks/week4-tasks.md)의 "MicroNetwork — 네트워크 격리 강화" 절에서 태스크로 진행한다.
