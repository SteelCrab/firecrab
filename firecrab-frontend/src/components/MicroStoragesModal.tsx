...
interface MicroStoragesModalProps {
  onClose: () => void;
}
 ...
 */
export default function MicroStoragesModal({ onClose }: MicroStoragesModalProps) {
    ...
    <div className="console-overlay">
      <div className="console-panel">
        <div className="console-bar">
          <span className="console-title">MicroStorage</span>
